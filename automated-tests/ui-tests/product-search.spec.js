...
test.describe('Product Search and Filtering Tests', () => {
  ...
  test.describe('Product Search Functionality', () => {
    ...
    test('should search products by partial name match', async ({ page }) => {
      ...
      const matchingProducts = productTitles.filter(
        (title) => title.toLowerCase().includes('blue') || title.toLowerCase().includes('bluetooth')
      );
    ...
    test('should show no results for non-existent products', async ({ page }) => {
      ...
      await expect(catalogPage.getNoResultsMessage()).toContainText(
        /No products found|No results|Nothing found/
      );
    });
  ...
  test.describe('Product Filtering', () => {
    ...
    test('should filter products by price range', async ({ page }) => {
      ...
      await catalogPage.filterByPriceRange(
        priceFilter.filterValue.min,
        priceFilter.filterValue.max
      );
