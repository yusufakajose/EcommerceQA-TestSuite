...
test.describe('User Registration Tests', () => {
  ...
  test.describe('Negative Registration Scenarios', () => {
    test('should show validation errors for empty required fields', async ({ page }) => {
      ...
      await expect(registrationPage.getFieldError('firstName')).toContainText('First name is required');
      
      await expect(registrationPage.getFieldError('lastName')).toBeVisible();
      await expect(registrationPage.getFieldError('lastName')).toContainText('Last name is required');
      ...
      await expect(registrationPage.getFieldError('password')).toContainText('Password is required');
    });
    ...
    test('should show error for invalid email format', async ({ page }) => {
      ...
      await expect(registrationPage.getFieldError('email')).toBeVisible();
      await expect(registrationPage.getFieldError('email')).toContainText('Please enter a valid email address');
    });
    ...
    test('should show error for weak password', async ({ page }) => {
      ...
      await expect(registrationPage.getFieldError('password')).toBeVisible();
      await expect(registrationPage.getFieldError('password')).toContainText(/Password must be at least 8 characters|Password is too weak/);
    });
    ...
    test('should show error for mismatched password confirmation', async ({ page }) => {
      ...
      await expect(registrationPage.getFieldError('confirmPassword')).toContainText('Passwords do not match');
    });
    ...
    test('should show error for existing email address', async ({ page }) => {
      ...
      await expect(registrationPage.getErrorMessage()).toContainText('Email address already exists');
    });
    ...
    test('should show error for invalid phone number format', async ({ page }) => {
      ...
      await expect(registrationPage.getFieldError('phone')).toContainText('Please enter a valid phone number');
    });
    ...
    test('should show error for names that are too long', async ({ page }) => {
      ...
      await expect(registrationPage.getFieldError('firstName')).toBeVisible();
      await expect(registrationPage.getFieldError('firstName')).toContainText(/too long|maximum length/);
      
      await expect(registrationPage.getFieldError('lastName')).toBeVisible();
      await expect(registrationPage.getFieldError('lastName')).toContainText(/too long|maximum length/);
    });
    ...
    test('should prevent registration with malicious input (XSS)', async ({ page }) => {
      ...
      const hasError = await registrationPage.getFieldError('firstName').isVisible().catch(() => false);
      if (!hasError) {
