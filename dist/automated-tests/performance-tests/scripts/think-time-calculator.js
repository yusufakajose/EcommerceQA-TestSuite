...
class ThinkTimeCalculator {
    constructor() {
        this.actionThinkTimes = {
            ...
            // Product interaction
            'view_product_details': { min: 5000, max: 15000, description: 'Time to read product details and reviews' },
            ...
            'checkout_start': { min: 2000, max: 5000, description: 'Time to decide to proceed with checkout' },
            'enter_shipping': { min: 30000, max: 90000, description: 'Time to enter shipping information' },
            'select_payment': { min: 10000, max: 30000, description: 'Time to select and enter payment method' },
            'review_order': { min: 15000, max: 45000, description: 'Time to review order before confirmation' },
            // User account
            ...
            'profile_update': { min: 30000, max: 120000, description: 'Time to update profile information' },
     ...
     */
    calculateSessionDuration(journey, userType = 'normal', device = 'desktop', timeOfDay = 'afternoon') {
        let totalMin = 0;
        let totalMax = 0;
        const actionDetails = [];
    ...
    recommendTestConfiguration(targetThroughput, averageSessionDuration, peakHours = false) {
        ...
        return {
            ...
            recommendations: [
                ...
                peakHours ? 'Configuration adjusted for peak hour traffic patterns' : 'Configuration for normal traffic patterns'
            ]
        };
    }
    /**
...
`);
    ...
    switch (command) {
        ...
        case 'journey': {
            ...
            console.log(`  Total Duration: ${sessionDuration.totalDuration.min}ms - ${sessionDuration.totalDuration.max}ms`);
        ...
        case 'report': {
            ...
            report.scenarios.forEach(scenario => {
                ...
                console.log(`    Duration: ${scenario.sessionDuration.average}ms (${scenario.actionCount} actions)`);
