...
test.describe('Cross-Browser Compatibility Tests', () => {
    ...
    test.describe('JavaScript API Compatibility', () => {
        ...
        test('should handle cookies across browsers', async ({ page }) => {
            ...
            const hasAuthCookie = authCookies.some(cookie => cookie.name.includes('auth') ||
    ...
    test.describe('Error Handling Across Browsers', () => {
        ...
        test('should handle JavaScript errors gracefully', async ({ page }) => {
            ...
            await catalogPage.addProductToCart('prod001');
            await page.waitForTimeout(2000);
            const criticalErrors = [...consoleErrors, ...pageErrors].filter(error => error.includes('TypeError') || error.includes('ReferenceError') || error.includes('SyntaxError'));
