...
class CrossBrowserTestUtils {
     ...
     */
    getBrowserConfig() {
        return CrossBrowserTestUtils.BROWSER_CONFIGS[this.browserName] ||
    ...
    async testInputTypeSupport() {
        const inputTypes = [
            'email', 'url', 'tel', 'number', 'range', 'date', 'time',
    ...
    async testCSSFeatureSupport() {
        ...
        for (const feature of cssFeatures) {
            ...
            const isSupported = await this.page.evaluate((prop, val) => {
    ...
    async testImageFormatSupport() {
        const formats = [
            { format: 'webp', dataUrl: 'data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA' },
            { format: 'avif', dataUrl: 'data:image/avif;base64,AAAAIGZ0eXBhdmlmAAAAAGF2aWZtaWYxbWlhZk1BMUIAAADybWV0YQ==' },
            { format: 'jpeg', dataUrl: 'data:image/jpeg;base64,' },
            { format: 'png', dataUrl: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChAGA6VP8AAAAABJRU5ErkJggg==' }
        ];
        const results = {};
    ...
    async generateCompatibilityReport(testElement = null) {
        ...
        const commonAPIs = [
            'fetch', 'Promise', 'localStorage', 'sessionStorage', 'indexedDB',
            'WebSocket', 'EventSource', 'navigator.serviceWorker', 'Notification',
