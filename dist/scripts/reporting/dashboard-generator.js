...
class DashboardGenerator {
    ...
    extractBrowserFromTest(test) {
        if (test.projectName) {
            if (test.projectName.toLowerCase().includes('chrome'))
                return 'Chrome';
            if (test.projectName.toLowerCase().includes('firefox'))
                return 'Firefox';
            if (test.projectName.toLowerCase().includes('safari'))
                return 'Safari';
            if (test.projectName.toLowerCase().includes('webkit'))
                return 'WebKit';
        }
        return 'Unknown';
    }
