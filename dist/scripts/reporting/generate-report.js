    ...
    <div class="container">
        <div class="filter-bar">
            ...
            <select id="envFilter">
                ...
                ${[...new Set([...mediaFiles.screenshots, ...mediaFiles.videos].map(f => f.environment))].map(env => `<option value="${env}">${env}</option>`).join('')}
            </select>
            
            <label>Filter by Browser:</label>
            <select id="browserFilter">
                <option value="">All Browsers</option>
                ${[...new Set([...mediaFiles.screenshots, ...mediaFiles.videos].map(f => f.browser))].map(browser => `<option value="${browser}">${browser}</option>`).join('')}
            </select>
